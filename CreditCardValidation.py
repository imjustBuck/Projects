#validates creditcard length and num sequence

cc = str(input("Enter a credit card number to validate (Mastercard, Visa, Discover, Amex): "))
...
if (int(cc[:2]) >= 51 and int(cc[:2]) <= 55 and len(cc) ==16) or \
    ...
    if val_cc(cc) % 10 == 0:
        ...
        print ("%s is NOT a calied credit card number" % cc)
